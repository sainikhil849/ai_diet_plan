    ...
    def generate_diet_plan(self, health_analysis: Dict, nlp_result: Dict = None, 
        ...
        for day in range(num_days):
            ...
            day_plan['daily_totals'] = {
                'calories': sum([
                    day_plan['breakfast'].get('calories', 0),
                    day_plan['lunch'].get('calories', 0),
                    day_plan['dinner'].get('calories', 0),
                    day_plan['snack'].get('calories', 0)
                ]),
                'protein': sum([
                    day_plan['breakfast'].get('protein', 0),
                    day_plan['lunch'].get('protein', 0),
                    day_plan['dinner'].get('protein', 0),
                    day_plan['snack'].get('protein', 0)
                ]),
                'carbs': sum([
                    day_plan['breakfast'].get('carbs', 0),
                    day_plan['lunch'].get('carbs', 0),
                    day_plan['dinner'].get('carbs', 0),
                    day_plan['snack'].get('carbs', 0)
                ]),
                'fat': sum([
                    day_plan['breakfast'].get('fat', 0),
                    day_plan['lunch'].get('fat', 0),
                    day_plan['dinner'].get('fat', 0),
                    day_plan['snack'].get('fat', 0)
                ]),
                'fiber': sum([
                    day_plan['breakfast'].get('fiber', 0),
                    day_plan['lunch'].get('fiber', 0),
                    day_plan['dinner'].get('fiber', 0),
                    day_plan['snack'].get('fiber', 0)
                ])
            }
